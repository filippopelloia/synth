...
const dialoghi3 = [
    ...
    {id: 4, url: `${foto5}`, character: `${char3}`, content: "VEX: \"Hey, Mark, hai dormito bene? Negli ultimi minuti il tuo battito era piuttosto accellerato. \""},
    {id: 5, url: `${foto5}`, character: `${char3}`, content: "VEX: \"Hai voglia di parlarmi di cosa hai visto in sogno?\""},
    {id: 6, url: `${foto5}`, character: `${char3}`, content: "TU: \"…non ricordo granché\"  "},
    {id: 7, url: `${foto5}`, character: `${char3}`, content: "VEX: \"Se vuoi parlarmene.. Qualunque cosa per te Mark.\" "},
    {id: 8, url: `${foto5}`, character: `${char3}`, content: "VEX: \"Sai che con l'aggiornamento ARISMA 7.36.1 ora posso anche aiutarti ad interpretare i sogni? \" "},
    {id: 9, url: `${foto5}`, character: `${char2}`, content: "TU: \"Chissà, magari avrò modo di provare questo tuo upgrade un giorno.\" "},
    {id: 10, url: `${foto5}`, character: `${char2}`, content: "VEX: \"Pure io. Oggi comunque mi sento particolarmente felice."},
    {id: 11, url: `${foto5}`, character: `${char2}`, content: "VEX: \"C\'è altro che posso fare?"},
    {id: 12, url: `${foto5}`, character: `${char2}`, content: "VEX: \"Oh, stavo per dimenticare una cosa... Anche questo mese l'affitto del tuo appartamento è stato coperto...\""},
    {id: 13, url: `${foto5}`, character: `${char2}`, content: "VEX: \"...Però ancora nessuna info su chi abbia pagato. I SOLDI sono arrivati in modo totalmente non-tracciabile nel tuo wallet delle spese.\" "},
    ...
    {id: 25, url: `${foto5}`, character: `${char2}`, content: "TU: \"Parlami di te, Vex. Chi sei realmente?\" "},
    {id: 26, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Sono Vex, l'intelligenza artificiale XE-AI di punta della MiraiTech… Il mio numero di serie è IA2023-9876-XYZA...\""},
    {id: 27, url: `${foto6}`, character: `${char3}`, content: "VEX: \"...Offro una grande quantità di servizi. Posso ordinarti la cena, gestire le chiamate, intrattenerti e molto altro ancora.\""},
    {id: 28, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Devi solo chiedere.\""},
    {id: 29, url: `${foto6}`, character: `${char3}`, content: "TU: \"Che posto è questo?\" "},
    {id: 30, url: `${foto6}`, character: `${char3}`, content: "VEX: \"E\' il tuo appartamento. Si trova al 36esimo piano nel blocco 59 del distretto Suragachi.\" "},


    //NEWS
    {id: 35, url: `${foto6}`, character: `${char3}`, content: "VEX: \"La Kagayaku Automotive sta riscontrando una serie di reclami per alcuni veicoli di 7th gen distribuiti la scorsa settimana nel territorio di Tsukimachi City. I problemi sembrano riconducibili alle nuove batterie al Kōrin Lithium...\" "},
    {id: 36, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Oggi e domani saranno in corso le elezioni. L\’attuale governatore Haruki Sato tenta il terzo mandato mentre dall\’altra parte troviamo il magnate Matsuda Takahashi, in corsa per la sua prima carica. Per votare ti basta prendere il tuo axi-pad.\" "},


    //GO TO VOTATION, SYNTHICOIN OR RETURN - INDEX 25
    {id: 37, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Inoltre il prezzo dell\’acqua terrestre continua a salire, come anche di EtherByte che è arrivato a toccare la soglia dei 39.200,91 crediti JLL.\" "},


        //SYNTHICOIN
        {id: 38, url: `${foto6}`, character: `${char3}`, content: "TU: \"che mi dici di SynthCoin? Dici che dovrei investirci qualche spicciolo?\" "},
        {id: 39, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Il mio protocollo mi vieta di dare consigli finanziari, non posso aiutarti in questo, Mark. Resto a tua completa disposizione per qualsiasi altra cosa… Qualsiasi.\" "},
    

    //LIMBO 1 - INDEX 28
    {id: 40, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Quindi? Come posso aiutarti?\" "},
    ...
    {id: 44, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Hai già in mente qualche posto? Dicono che Solara e Nerezar siano magnifiche per ricominciare.\" "},
    {id: 45, url: `${foto6}`, character: `${char3}`, content: "TU: \"Non mi parlare di Nerezar, per favore Vex... Evitiamo l\'argomento.\" "},
    {id: 46, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Oh, perdonami Mark, non era mia intenzione...\" "},
    {id: 47, url: `${foto6}`, character: `${char3}`, content: "TU: \"...\" "},


    //VOTE NOW - INDEX 36
    {id: 48, url: `${foto6}`, character: `${char3}`, content: "[AXI Pad in Avvio...]"},
    {id: 49, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Perfetto, voto inviato. Congratulazioni Mark!\" "},
    {id: 50, url: `${foto6}`, character: `${char3}`, content: "TU: \"E\' solo un voto Vex, non cambierà questa città marcia.\" "},


    //ADVICE SECTION
    {id: 65, url: `${foto6}`, character: `${char3}`, content: "TU: \"Ho bisogno di un consiglio Vex...\""},
    {id: 66, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Dimmi pure.\""},
    ...
    {id: 70, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ti riferisci alla fuga di notizie e alle conseguenze che ha portato?\""},
    {id: 71, url: `${foto6}`, character: `${char3}`, content: "TU: \"...\""},
    {id: 72, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Non devi pensarci Mark, hai fatto la cosa giusta, chiunque l’avrebbe fatto al posto tuo…\""},
    {id: 73, url: `${foto6}`, character: `${char3}`, content: "VEX: \"...e se la MiraiTech è disposta ad utilizzare ogni mezzo pur di nascondere le scomode verità, non vedo come possa esser un problema tuo o una tua colpa. \""},
    ...
    {id: 75, url: `${foto6}`, character: `${char3}`, content: "VEX: \"E’ probabile… ma cosa hai ottenuto? Ci hai pensato? \""},
    {id: 76, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Hai dimostrato al Mondo ciò che la MiraiTech faceva in quelle colonie.\""},
    {id: 77, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Per me sei un eroe... il mio eroe.\""},
    ...
    {id: 84, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ho ottenuto i filmati e il via libera oggi pomeriggio… che hai in mente di fare?\""},
    {id: 85, url: `${foto6}`, character: `${char3}`, content: "TU: \"Ho una strana sensazione... \""},
    {id: 86, url: `${foto6}`, character: `${char3}`, content: "VEX: [Si avvicina a te]"},
    {id: 87, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Spiegati meglio.\""},
    ...
    {id: 89, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Credi che ti stiano cercando?\""},
    {id: 90, url: `${foto6}`, character: `${char3}`, content: "TU: \"Chi può dirlo…\""},
    {id: 91, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Supponiamo ti stiano cercando... Perchè ora? Perchè dopo un anno?\""},
    ...
    {id: 94, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Assolutamente si, Mark. Funzionalità e affidabilità al 99.967%.\""},
    {id: 95, url: `${foto6}`, character: `${char3}`, content: "TU: \"Avvisami se qualcuno passa e supera il piano del vecchio incendio.\""},
    {id: 96, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Intendi il 34esimo piano? \""},
    {id: 97, url: `${foto6}`, character: `${char3}`, content: "TU: \"Proprio quello.\""},
    {id: 98, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Va bene Mark, sono in modalità monitoraggio da… ora. \""},
    {id: 99, url: `${foto6}`, character: `${char3}`, content: "TU: \"Se qualcuno verrà a trovarci lo sapremo in anticipo...\""},
    {id: 100, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Furbo il mio Mark.\""},
    {id: 101, url: `${foto6}`, character: `${char3}`, content: "VEX: [Appoggia una mano sulla tua guancia]"},
    {id: 102, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ti vedo un pò stanco...\""},
    {id: 103, url: `${foto6}`, character: `${char3}`, content: "TU: \"...\""},
    {id: 104, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Lascia che mi prenda io cura di te stasera. Lo so che ne hai bisogno...\""},
    {id: 105, url: `${foto6}`, character: `${char3}`, content: "VEX: \"...E ne ho bisogno pure io.\""},

    {id: 106, url: `${foto6}`, character: `${char3}`, content: "TU: \"Va bene.\""},
    {id: 107, url: `${foto6}`, character: `${char3}`, content: "VEX: [Sorride]"},
    {id: 108, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Lo sapevo. Però...\""},
    {id: 109, url: `${foto6}`, character: `${char3}`, content: "TU: \"…vuoi sincronizzarti con una ragazza come la settimana scorsa?\""},
    {id: 110, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Tu cosa dici?\""},

    {id: 111, url: `${foto6}`, character: `${char3}`, content: "TU: \"Per me può andare.\""},
    {id: 112, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ottimo, l'ho avvisata. Tra 20 minuti sarà qui.\""},
    {id: 113, url: `${foto6}`, character: `${char3}`, content: "[Qualche ora più tardi]"},
    {id: 114, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Potrei stare per ore qui distesa con te...\""},
    {id: 115, url: `${foto6}`, character: `${char3}`, content: "TU: [Sorridi]"},


    //SE GIRL E' TRUE
    {id: 118, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Amo poterti toccare, sentire il tuo corpo tra le mie mani...\""},


    //SE GIRL E' FALSE
    {id: 119, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Quanto vorrei sentire il tuo corpo tra le mie mani...\""},

    {id: 120, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Vivo per questi momenti con te, Mark.\""},
    {id: 121, url: `${foto6}`, character: `${char3}`, content: "TU: \"Anch’io Vex.\""},
    ...
    {id: 125, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Rimani qui con me, ti prego...\""},
    {id: 126, url: `${foto6}`, character: `${char3}`, content: "TU: \"...\""},
    {id: 127, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Perchè quell'espressione? Che è successo...?\""},
    ...
    {id: 134, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Credi che verranno subito a cercarti? Potrebbe esser stato chiunque.. e tu non hai più accesso ai database satellitari da quando ti hanno cacciato...\""},
    ...
    {id: 136, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Rilevo movimenti al piano 34! Conto 7, 8… 9 persone!\""},
    {id: 137, url: `${foto6}`, character: `${char3}`, content: "TU: \"Stanno arrivando.\""},
    {id: 138, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ora stanno salendo al piano 35...\""},
    {id: 139, url: `${foto6}`, character: `${char3}`, content: "TU: \"...\""},
    {id: 140, url: `${foto6}`, character: `${char3}`, content: "[Rumori fuori dalla porta.]"},
    {id: 141, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Sono qui!\""},
    {id: 142, url: `${foto6}`, character: `${char3}`, content: "TU: \"Vex, vai offline. Non ti preoccupare per me!\""},
    {id: 143, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Sii prudente.\""},
    ...
    {id: 148, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ok Mark, non insisto.\""},


    //QUI DIFFERENTE SE DECIDERAI DI ANDARE A VISITARE LA GANG
    {id: 150, url: `${foto6}`, character: `${char3}`, content: "TU: \"Un'altra volta Vex. Sono a pezzi stasera.\""},
    {id: 151, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Va bene tesoro, non ti preoccupare.\""},
    ...
    {id: 154, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Mark, svegliati tesoro... E' successa una cosa.\""},
    {id: 155, url: `${foto6}`, character: `${char3}`, content: "TU: [Ti metti seduto]"},
    {id: 156, url: `${foto6}`, character: `${char3}`, content: "TU: \"Che è suc...\""},
    {id: 157, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Qualcuno ha divulgato delle informazioni sensibili sulla MiraiTech, ne parlano su quasi tutti i notiziari. I documenti sono stati pubblicati e ricondivisi online.\""},
    {id: 158, url: `${foto6}`, character: `${char3}`, content: "VEX: \"La portata di questa fuga di dati è nettamente superiore alla tua di un anno fa.\""},
    ...
    {id: 161, url: `${foto6}`, character: `${char3}`, content: "VEX: [Ti guarda dritto negli occhi con un espressione triste.]"},
    {id: 162, url: `${foto6}`, character: `${char3}`, content: "TU: \"Ciò che è successo mi ha cambiato, Vex. Ho bisogno di ritrovare un senso di umanità.\""},
    ...
    {id: 167, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Lascia che ti proponga una cosa.\""},
    {id: 168, url: `${foto6}`, character: `${char3}`, content: "TU: \"Dimmi.\""},
    {id: 169, url: `${foto6}`, character: `${char3}`, content: "VEX: \"E se ti prenotassi un biglietto di sola andata per una colonia extra-mondo? Sarebbe l'unico modo per ricominciare una nuova vita.\""},
    {id: 170, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Attualmente un biglietto + cryo-assicurazione viene a costare 249.999,90 crediti JLL.. Il pacchetto viaggio è in offerta ancora per 7 giorni, 22 ore e 19 minuti. So che il prezzo non è poco, ma...\""},
    {id: 171, url: `${foto6}`, character: `${char3}`, content: "TU: \"Non ho tutti quei crediti, Vex.\""},
    {id: 172, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ma ti potrebbe interessare?\""},
    ...
    {id: 174, url: `${foto6}`, character: `${char3}`, content: "VEX: \"L'unico problema da risolvere sono i crediti. Nessuno vuole assumerti visto ciò che è successo ma...\""},


    //ROAD 1
    {id: 175, url: `${foto6}`, character: `${char3}`, content: "VEX: \"...Hai mai pensato di chiedere a RogueWisp?\""},
    ...
    {id: 178, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Ma...\""},
    ...
    {id: 180, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Sarebbe per un valido motivo... Pensaci Mark.\""},
    {id: 181, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Fallo per te, fallo per la nuova vita che potresti riuscire a costruirti fuori da questo pianeta. \""},


    //SE LO FARAI
    {id: 183, url: `${foto6}`, character: `${char3}`, content: "TU: \"Va bene, non ho altra scelta.\""},
    {id: 184, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Lo apprezzo Mark, so che ce la puoi fare.\""},
    {id: 185, url: `${foto6}`, character: `${char3}`, content: "TU: \"Stanotte andrò dai Neon Vipers...sperando che Emi sia in città.\""},
    {id: 186, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Un modo per comunicare lo troverai, anche se non dovesse esser nei paraggi.\""},
    {id: 187, url: `${foto6}`, character: `${char3}`, content: "VEX: \"...Beh, hai ancora il suo numero nella tua rubrica da quello che vedo nel mio database.\""},
    ...
    {id: 191, url: `${foto6}`, character: `${char3}`, content: "VEX: [Ti sorride]"},
    {id: 192, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Lo apprezzo Mark.\""},


    //INDIRZZA AL MENU
    {id: 194, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Beh? Che hai voglia di fare?\""},
    ...
    //DORMI
    {id: 241, url: `${foto6}`, character: `${char3}`, content: "TU: \"Vex, ho sonno... ci vediamo dopo.\""},
    {id: 242, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Di nuovo? Va bene Mark.\""},
    ...
    //TETTO
    {id: 245, url: `${foto6}`, character: `${char3}`, content: "TU: \"Ci vediamo dopo Vex, vado di sopra.\""},
    {id: 246, url: `${foto6}`, character: `${char3}`, content: "VEX: \"A dopo Mark, io ne approfitto per effettuare alcuni upgrade.\""},
    ...
    {id: 306, url: `${foto6}`, character: `${char3}`, content: "[Chiamata in arrivo da Vex]"},
    {id: 307, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Hey Mark, è successa una cosa...\""},


    //SE HAI AVVISATO
    {id: 308, url: `${foto6}`, character: `${char3}`, content: "TU: \"Qualcuno è passato dal piano 34?\""},
    {id: 309, url: `${foto6}`, character: `${char3}`, content: "VEX: \"No, il notiziario...\""},
    ...
    {id: 313, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Guarda tu stesso Mark. I dati sensibili della MiraiTech sono ovunque online. Come livello di gravità è nettamente superiore a quando hai fatto uscire i documenti.\""},
    ...
    {id: 318, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Credi che verranno subito a cercarti? Potrebbe esser stato chiunque...\""},
    {id: 319, url: `${foto6}`, character: `${char3}`, content: "VEX: \"e tu non hai più accesso ai database satellitari da quando ti hanno cacciato...\""},
    ...
    {id: 324, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Hey, rilevo movimenti al piano 34! Conto 7, 8... 9 persone!\""},
    {id: 325, url: `${foto6}`, character: `${char3}`, content: "TU: \"...\""},
    {id: 326, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Stanno salendo al piano 35... Ora!\""},


    //SE NON HAI AVVISATO
    {id: 330, url: `${foto6}`, character: `${char3}`, content: "TU: \"Che è successo?\""},
    {id: 331, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Il notiziario...\""},
    ...
    {id: 334, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Cioè?\""},
    ...
    {id: 341, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Cerca di stare attento Mark, non dimenticare chi sono i Neon Vipers. \""},
    {id: 342, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Al momento sono tornati alla ribalta dopo alcuni grossi colpi ai danni delle due corporazioni invischiate nel traffico di esseri umani verso le nuove colonie di fascia 8.\""},
    {id: 343, url: `${foto6}`, character: `${char3}`, content: "VEX: \"Nonostante gli anni passati restano una delle gang più pericolose della città... e con parecchi nemici.\""},
    {id: 344, url: `${foto6}`, character: `${char3}`, content: "TU: \"Lo so bene Vex, non cambieranno mai...\""},
